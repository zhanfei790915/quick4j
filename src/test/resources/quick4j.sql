...
CREATE TABLE `test` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'testid',
  `name` varchar(255) unsigned DEFAULT NULL COMMENT 'testname',
  `descr` varchar(255) unsigned DEFAULT NULL COMMENT 'testdesc',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='test mybatis gener表';
