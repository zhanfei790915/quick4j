...
<div class="content">
	...
	<form class="login-form" action="rest/user/login" method="post">
		...
		<div class="form-actions">
			...
			<input type="checkbox" name="remember" value="1"/>保存账号信息</label>
	...
	<form class="register-form" action="rest/user/registe" method="post">
		<h3>注册账号</h3>
		<p class="hint">
			 输入您的个人详细信息:
		</p>
		...
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">城市/地区</label>
			<input class="form-control placeholder-no-fix" type="text" placeholder="城市/地区" name="city"/>
		</div>
		<div class="form-group">
		...
		<div class="form-group margin-top-20 margin-bottom-20">
			<label class="check">
			<input type="checkbox" name="tnc"/> 同意  <a href="javascript:;">
			服务条款 </a>
			和 <a href="javascript:;">
			隐私政策 </a>
			</label>
